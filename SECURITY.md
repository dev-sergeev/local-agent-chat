...
Проект рассчитан на одного доверенного пользователя внутри JupyterHub. Фиксированный Local User в Chainlit полагается на аутентификацию внешнего прокси; прямой порт не является самостоятельной границей аутентификации.
